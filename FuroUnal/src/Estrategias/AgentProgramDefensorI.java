 ...
 */
public class AgentProgramDefensorI implements AgentProgram
{

	public final static double PI=3.1415923;
	public final static double ox=60;//solo funciona para equipo a la Izquierda
	public final static double oy=135;//solo funciona para equipo a la Izquierda
	...
	public AgentProgramDefensorI(int _id)
	{
		init();
		id=_id;
	}
	public void init() 
	{
		AreaAccion=new Bounds(0,130,180,90);
		 eant=0;
		 Yant=0;
		 vleft=0;
		 vright=0;
