 ...
 */
public class AgentProgramOpponentAtt implements AgentProgram
{

	public final static double PI=3.1415923;
	public double ox=130;//solo funciona para equipo a la Izquierda
	...
	public AgentProgramOpponentAtt(int _id)
	{
		id=_id;
		init();
	...
	public void init() 
	{
		...
		{
			AreaAccion=new Bounds(0,100,180,0);
			ox=40;
		}
