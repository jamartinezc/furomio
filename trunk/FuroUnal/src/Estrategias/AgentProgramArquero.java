...
public class AgentProgramArquero implements AgentProgram
{
	...
	public AgentProgramArquero(int _id)
	{
		init();
		id=_id;
		j=0;
	...
	public Action compute(Percept p) 
	{
		...
		//{
		//j=1;	
		if(Math.abs(home.elementAt(id).getPos().getX())<=30)//esta cerca a su arco
			BloqueaArquero(home);
		else
	...
	public void init() 
	{
		 AreaAccion=new Bounds(8,50,115,65);		 
		 eant=0;
		 Yant=0;
		 vleft=0;
		 vright=0;
