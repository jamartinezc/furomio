 ...
 */
public class AgentProgramAtacante implements AgentProgram
{
	...
	public Action compute(Percept p) 
	{
		...
		{	
			Atacabola((Vector<Robot>) p.getAttribute("home"),bx+10,by,p);	
		}
		else
		{
	...
	public AgentProgramAtacante(int _id)
	{
		id=_id;
		init();
	...
	{
		if(id<5)
		AreaAccion=new Bounds(90,220,180,0);
		else
		{
