 ...
 */
public class AgentProgramBase implements AgentProgram
{

	public final static double PI=3.1415923;
	public final static double ox=90.47;//solo funciona para equipo a la Izquierda
	public final static double oy=42.13;//solo funciona para equipo a la Izquierda
	...
	public final static double v=150;
	...
	public AgentProgramBase(int _id)
	{
		init();
		id=_id;
	}
